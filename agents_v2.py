...
Multi-Agent Fraud Detection System v2
...
if __name__ == '__main__':
    ...
    if args.data_root:
        ...
        # Force the path directly
    BASE = "/Users/anastasiiakravchenko/Downloads/files (2)"

    #     # (Comment out or delete the CANDIDATES loop below it)
    # for c in CANDIDATES:
    #     if os.path.isdir(c):
    #         BASE = c
    #         break
    ...
    DATASETS = {
        'truman_train': os.path.join(BASE, 'The Truman Show - train'),
        'bnw_train': os.path.join(BASE, 'Brave New World - train'),
        'deus_train': os.path.join(BASE, 'Deus Ex - train'),
        'truman_val': os.path.join(BASE, 'The Truman Show - validation'),
        'bnw_val': os.path.join(BASE, 'Brave New World - validation'),
        'deus_val': os.path.join(BASE, 'Deus Ex - validation'),
    }
